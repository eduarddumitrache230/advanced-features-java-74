...
/*
    ...
    Valorile reprezinta o sublista a Mapei constituenta din valori de orice fel (unice si dublicitare)
...
public class MapTheory {
    public static void main(String[] args) {
        ...
        // PUT = simetricul din List/Set a lui Add
        ...
        System.out.println("---------------------------------------------");
        //Enhanced for - value
        System.out.println("Enhanced for values example: ");
